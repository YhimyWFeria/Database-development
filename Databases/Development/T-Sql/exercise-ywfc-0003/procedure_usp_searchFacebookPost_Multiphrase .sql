...
ALTER PROCEDURE usp_searchFacebookPost_Multiphrase 
(
  @p_search_words_one nvarchar(500)='Lima',
  @p_search_words_two varchar(100) ='obras',
  @p_search_not_words_four varchar(100) ='',
  @fechaInicial date ='2024-01-13',
  @fechaFinal date ='2024-04-14',
  @p_between_list_word  INT  = 50
)
AS BEGIN
...
SELECT  PK_FacebookPost,  [Message] FROM   [dbo].[FacebookPosts]
WHERE  (CAST(CreatedTime AS date)  between @fechaInicial and  @fechaFinal)  AND  contains([Message],@p_searchTextFilter) 
